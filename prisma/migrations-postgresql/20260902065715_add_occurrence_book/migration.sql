...
-- AddForeignKey
ALTER TABLE "OccurrenceBook" ADD CONSTRAINT "OccurrenceBook_categoryId_fkey" FOREIGN KEY ("categoryId") REFERENCES "OccurrenceCategory"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "OccurrenceBook" ADD CONSTRAINT "OccurrenceBook_reportedById_fkey" FOREIGN KEY ("reportedById") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "OccurrenceBook" ADD CONSTRAINT "OccurrenceBook_linkedItemId_fkey" FOREIGN KEY ("linkedItemId") REFERENCES "Item"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "OccurrenceBook" ADD CONSTRAINT "OccurrenceBook_linkedClaimId_fkey" FOREIGN KEY ("linkedClaimId") REFERENCES "Claim"("id") ON DELETE SET NULL ON UPDATE CASCADE;
